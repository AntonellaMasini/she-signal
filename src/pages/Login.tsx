...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <div className="container max-w-sm pt-32 pb-16 px-4">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
          <h1 className="text-5xl font-display tracking-wider text-gradient-gold mb-2 text-center">
            {mode === "signin" ? "Welcome Back" : "Join SheSignal"}
          </h1>
          <p className="text-muted-foreground text-center mb-8 font-body text-sm">
            {mode === "signin"
              ? "Sign in to access your personalized signals."
          ...
          <div className="space-y-4">
            ...
            <Button
              className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-display text-lg tracking-wider py-6 signal-glow"
            ...
            <Button
              variant="outline"
              className="w-full border-border hover:border-primary hover:text-primary py-5"
